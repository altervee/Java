...
public class PruebaVehiculos {
  ...
  public static void main(String[] args) {
    ...
    int opcion = 0;//inicialiar variables
    int km;//cuantos kilometros vamos a reorrer
    
    Bicicleta bhSpeedrom = new Bicicleta(9);//crear objeto bicileta
    Coche saab93 = new Coche(1900);//crear objeto coche
