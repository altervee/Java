...
public abstract class Vehiculo {//cuando no vamos a crear ibjetos de dicha clase
  
  // atributos de clase
  private static int kilometrosTotales = 0;
  private static int vehiculosCreados = 0;//crear atributos de clase son los static
  
  // atributos de instancia
  private int kilometrosRecorridos;
  
  public Vehiculo() {
    this.kilometrosRecorridos = 0; //this es un constructor
  }
  ...
  public static int getKilometrosTotales() { // como es un static no ponemos this,ponemos el nombre de la clase (vehiculo)
